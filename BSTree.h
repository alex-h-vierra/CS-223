 ...
 public:
	...
	*/
	bool insert( Value value,  KeyComparable key) {
        ...
        BinaryNode *temp = new BinaryNode(key, value);
        BinaryNode *iterator = root;
        if (root == nullptr)
        {
            cout << "Inserted In a empty Tree: " << temp->key << endl;
            root = temp;
            return true;
        }
        while (iterator != nullptr)
        {
            if (iterator->key > temp->key)
            {
                ...
                {
                    cout << "Inserting Left with " << temp->key << endl;
                    iterator->left = temp;
                    return true;
                }
            ...
            else if (iterator->key < key)
            {
                ...
                {
                    cout << "Inserting Right with " << temp->key << endl;
                    iterator->right = temp;
                    return true;
                }
